...
export default function Manage() {
  return (
      ...
      <section id='About' className={`flex flex-col sm:flex-row  justify-between gap-x-10 gap-y-4 sm:gap-y-0`} >
      ...
      >
        ...
        <div class="flex flex-col space-y-12 md:w-1/2">
          ...
          <p class="max-w-sm text-center  text-dimBlack md:text-left">
